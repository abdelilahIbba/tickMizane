            ...
            <div class="lg:col-span-2 bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-amber-400">{{ number_format(array_sum($monthlyRevenue['revenue']), 2) }} DH</p>
                        ...
                        @forelse($recentSales as $vente)
                            <div class="flex items-center justify-between p-4 bg-gray-900 rounded-xl">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="font-medium text-white">Vente #{{ str_pad($vente->id, 4, '0', STR_PAD_LEFT) }}</p>
                                        <p class="text-sm text-gray-400">{{ $vente->created_at->format('d/m/Y H:i') }} - {{ $vente->user->name ?? 'N/A' }}</p>
                                    </div>
                                </div>
                                <span class="text-lg font-semibold text-amber-400">{{ number_format($vente->total, 2) }} DH</span>
                            </div>
                        @empty
                            ...
                            <div class="p-4 bg-red-500/10 border border-red-500/30 rounded-xl">
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-400">Stock: {{ $product->stock_quantity }} / Alerte: {{ $product->alert_stock }}</p>
                                    </div>
