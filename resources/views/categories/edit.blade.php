<x-layout.app title="Modifier la catégorie">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-400 mt-1">Modifier les informations de la catégorie</p>
        </div>
        ...
        <x-ui.card>
            ...
            <form action="{{ route('categories.update', $category ?? 1) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <x-form.textarea 
                    ...
                    value="{{ $category->description ?? 'Eau, jus, sodas et boissons chaudes' }}"
                    rows="4"
                />
                ...
                <x-form.input
                    ...
                    placeholder="https://..."
                    :value="old('image_url', \Illuminate\Support\Str::startsWith((string) ($category->image ?? ''), ['http://', 'https://']) ? $category->image : '')"
                />
                ...
                <div class="mb-4">
                    ...
                    @if(isset($category) && $category->image_url)
                        <div class="mb-3">
                            <img src="{{ $category->image_url }}" alt="Image catégorie" class="h-20 w-20 object-cover rounded-lg border border-gray-700">
                        </div>
                    @endif
