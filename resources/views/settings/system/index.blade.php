...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <a href="{{ route('settings.wifi-qr.index') }}" class="flex items-center gap-4 p-4 bg-gray-900/30 rounded-lg border border-gray-800 hover:border-orange-500 transition-colors">
            ...
            <div>
                <h4 class="text-white font-medium">Commandes Client (QR)</h4>
                <p class="text-sm text-gray-400">Page de commande & codes QR Wi-Fi</p>
            </div>
        </a>
    </div>
</div>
