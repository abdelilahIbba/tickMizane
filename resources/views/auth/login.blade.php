    ...
    <div class="w-full max-w-md" x-data="{ loading: false }">
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-2xl shadow-2xl p-8">
            ...
            <div class="mt-8 pt-6 border-t border-gray-700">
                <p class="text-sm text-gray-400 text-center mb-4">Rôles disponibles:</p>
                <div class="grid grid-cols-3 gap-2 text-center text-xs">
                    ...
                    <div class="bg-gray-900 rounded-lg p-3">
                        <div class="w-8 h-8 bg-amber-500/20 rounded-full flex items-center justify-center mx-auto mb-2">
                            <svg class="w-4 h-4 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                            </svg>
                        </div>
                        <span class="text-gray-300 font-medium">Caissier</span>
                    </div>
                    <div class="bg-gray-900 rounded-lg p-3">
                        ...
                        <span class="text-gray-300 font-medium">Serveur</span>
                    </div>
                </div>
            </div>
        </div>
