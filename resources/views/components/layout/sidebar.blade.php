@php
    ...
    $navGroups = [
        ...
        'operations' => [
            ...
            'items' => [
                ...
                'kitchen' => ['label' => 'Validation cuisine', 'route' => 'kitchen.index', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.879 16.121A3 3 0 1012.015 11L11 14H9c0 .768.293 1.536.879 2.121z"/>'],
                ...
                'commandes_en_attente' => ['label' => 'Commandes prêtes', 'route' => 'cashier.pending', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>'],
        ...
        'settings' => [
            ...
            'items' => [
                ...
                'room_service' => ['label' => 'Service de chambre', 'route' => 'settings.room-service.index', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>'],
                'qr_codes' => ['label' => 'Codes QR Chambres', 'route' => 'settings.room-service.qr-codes', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z"/>'],
    ...
    $roleAccess = [
        'admin' => [
            'main' => ['dashboard', 'pos', 'ventes', 'tables'],
            ...
            'settings' => ['articles', 'system', 'users', 'permissions', 'room_service', 'qr_codes'],
        ],
        'caissier' => [
            'main' => ['pos', 'ventes'],
            'operations' => ['cashier'],
