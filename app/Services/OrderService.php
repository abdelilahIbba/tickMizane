 ...
 *
 * تحتوي على كامل منطق الأعمال المتعلق بالطلبيات:
 *
 * طلبيات الموردين:
 * - إنشاء وتعديل وإلغاء وإتمام استلام الطلبيات
 * - تحديث المخزون تلقائياً عند الاستلام
 *
 * طلبيات المطبخ:
 * - إنشاء طلبية من النادل أو من العميل مباشرة
 * - إضافة عناصر إلى طلبية قائمة
 * - تحديث حالة الطلبية عبر مراحلها
 * - معالجة الدفع وتحرير الطاولة
 * - توليد بيانات التذاكر للمطبخ
 *
 * يعتمد على StockService لإدارة حركات المخزون
 */
class OrderService
{
