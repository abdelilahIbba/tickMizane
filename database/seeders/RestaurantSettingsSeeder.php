...
class RestaurantSettingsSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            // ── General / Business ─────────────────────────────────────────
            ['group' => 'general',   'key' => 'business_name',    'value' => 'Oussoul House',                       'type' => 'string',  'label' => 'Nom de l\'établissement'],
            ['group' => 'general',   'key' => 'business_address', 'value' => 'Oussoul House, Restaurant & Hotel',   'type' => 'string',  'label' => 'Adresse'],
            ['group' => 'general',   'key' => 'business_phone',   'value' => '06-60-43-27-86',                      'type' => 'string',  'label' => 'Téléphone'],
            ['group' => 'general',   'key' => 'business_email',   'value' => 'contact@oussoulhouse.ma',             'type' => 'string',  'label' => 'Email'],
            ...
            ['group' => 'stock',     'key' => 'stock_notification_email',    'value' => 'stock@oussoulhouse.ma', 'type' => 'string', 'label' => 'Email pour les alertes stock'],
            ...
            // ── Receipts ───────────────────────────────────────────────────
            ['group' => 'receipts',  'key' => 'receipt_header',      'value' => "Oussoul House\nRESTAURANT & HOTEL\n06-60-43-27-86", 'type' => 'string', 'label' => 'En-tête du ticket'],
            ['group' => 'receipts',  'key' => 'receipt_footer',      'value' => 'Merci de votre visite !', 'type' => 'string', 'label' => 'Pied de page du ticket'],
