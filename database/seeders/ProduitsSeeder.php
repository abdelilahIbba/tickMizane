...
class ProduitsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $produits = [
            ...
            ['category' => 'Entrées & Salades', 'name' => '5 salades marocaines (plateau)',          'image' => 'https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=640&q=80', 'price_vente' => 55.00,  'price_achat' => 18.00, 'stock_quantity' => 20, 'alert_stock' => 5,  'unit' => 'portion'],

            // ── Pastilla & Specialites ───────────────────────────────────────
            ['category' => 'Pastilla & Spécialités', 'name' => 'Pastilla au pigeon (4 pers.)',       'image' => 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?auto=format&fit=crop&w=640&q=80', 'price_vente' => 160.00, 'price_achat' => 80.00, 'stock_quantity' => 8,  'alert_stock' => 2,  'unit' => 'piece'],
            ['category' => 'Pastilla & Spécialités', 'name' => 'Pastilla au poisson et fruits de mer', 'image' => 'https://images.unsplash.com/photo-1519984388953-d2406bc725e1?auto=format&fit=crop&w=640&q=80', 'price_vente' => 140.00, 'price_achat' => 70.00, 'stock_quantity' => 8, 'alert_stock' => 2, 'unit' => 'piece'],
            ...
            // ── Pains & Galettes ─────────────────────────────────────────────
            ['category' => 'Pains & Galettes', 'name' => 'Khobz (pain traditionnel maison)',         'image' => 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=640&q=80', 'price_vente' => 5.00,   'price_achat' => 1.50,  'stock_quantity' => 100,'alert_stock' => 20, 'unit' => 'piece'],
            ['category' => 'Pains & Galettes', 'name' => 'Msemen (crepe feuilletee)',                'image' => 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=640&q=80', 'price_vente' => 8.00,   'price_achat' => 2.50,  'stock_quantity' => 60, 'alert_stock' => 15, 'unit' => 'piece'],
            ['category' => 'Pains & Galettes', 'name' => 'Meloui (crepe roulee au miel)',            'image' => 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=640&q=80', 'price_vente' => 10.00,  'price_achat' => 3.00,  'stock_quantity' => 40, 'alert_stock' => 10, 'unit' => 'piece'],
            ['category' => 'Pains & Galettes', 'name' => 'Batbout (pain farci kefta-fromage)',       'image' => 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?auto=format&fit=crop&w=640&q=80', 'price_vente' => 18.00,  'price_achat' => 6.00,  'stock_quantity' => 30, 'alert_stock' => 8,  'unit' => 'piece'],
            ['category' => 'Pains & Galettes', 'name' => 'Harcha (galette semoule au beurre)',       'image' => 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=640&q=80', 'price_vente' => 8.00,   'price_achat' => 2.50,  'stock_quantity' => 40, 'alert_stock' => 10, 'unit' => 'piece'],

            // ── Boissons ─────────────────────────────────────────────────────
            ['category' => 'Boissons', 'name' => 'The a la menthe (theiere)',                        'image' => 'https://images.unsplash.com/photo-1544145945-f90425340c7e?auto=format&fit=crop&w=640&q=80', 'price_vente' => 25.00,  'price_achat' => 5.00,  'stock_quantity' => 200,'alert_stock' => 30, 'unit' => 'theiere'],
            ['category' => 'Boissons', 'name' => 'The a la menthe (verre)',                          'image' => 'https://images.unsplash.com/photo-1544145945-f90425340c7e?auto=format&fit=crop&w=640&q=80', 'price_vente' => 10.00,  'price_achat' => 2.00,  'stock_quantity' => 300,'alert_stock' => 50, 'unit' => 'verre'],
            ['category' => 'Boissons', 'name' => "Jus d'orange frais presse",                       'image' => 'https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?auto=format&fit=crop&w=640&q=80', 'price_vente' => 20.00,  'price_achat' => 7.00,  'stock_quantity' => 80, 'alert_stock' => 15, 'unit' => 'verre'],
            ['category' => 'Boissons', 'name' => "Jus d'avocat au lait",                            'image' => 'https://images.unsplash.com/photo-1623065422902-30a2d299bbe4?auto=format&fit=crop&w=640&q=80', 'price_vente' => 25.00,  'price_achat' => 10.00, 'stock_quantity' => 50, 'alert_stock' => 10, 'unit' => 'verre'],
            ['category' => 'Boissons', 'name' => 'Jus de grenade frais',                            'image' => 'https://images.unsplash.com/photo-1586348943529-beaae6c28db9?auto=format&fit=crop&w=640&q=80', 'price_vente' => 22.00,  'price_achat' => 8.00,  'stock_quantity' => 40, 'alert_stock' => 10, 'unit' => 'verre'],
            ['category' => 'Boissons', 'name' => "Citronnade a la fleur d'oranger",                 'image' => 'https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?auto=format&fit=crop&w=640&q=80', 'price_vente' => 18.00,  'price_achat' => 5.00,  'stock_quantity' => 60, 'alert_stock' => 12, 'unit' => 'verre'],
            ['category' => 'Boissons', 'name' => 'Cafe marocain (noir)',                             'image' => 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=640&q=80', 'price_vente' => 12.00,  'price_achat' => 3.00,  'stock_quantity' => 150,'alert_stock' => 25, 'unit' => 'tasse'],
            ['category' => 'Boissons', 'name' => 'Cafe au lait (nous-nous)',                         'image' => 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?auto=format&fit=crop&w=640&q=80', 'price_vente' => 14.00,  'price_achat' => 4.00,  'stock_quantity' => 100,'alert_stock' => 20, 'unit' => 'tasse'],
            ['category' => 'Boissons', 'name' => 'Eau minerale Sidi Ali 50cl',                      'image' => 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?auto=format&fit=crop&w=640&q=80', 'price_vente' => 6.00,   'price_achat' => 2.50,  'stock_quantity' => 120,'alert_stock' => 24, 'unit' => 'bouteille'],
            ['category' => 'Boissons', 'name' => 'Eau minerale Ain Atlas 1.5L',                     'image' => 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?auto=format&fit=crop&w=640&q=80', 'price_vente' => 10.00,  'price_achat' => 4.00,  'stock_quantity' => 80, 'alert_stock' => 18, 'unit' => 'bouteille'],
            ['category' => 'Boissons', 'name' => 'Eau gazeuse Belvita 50cl',                        'image' => 'https://images.unsplash.com/photo-1568213816046-0ee1c42bd559?auto=format&fit=crop&w=640&q=80', 'price_vente' => 8.00,   'price_achat' => 3.50,  'stock_quantity' => 60, 'alert_stock' => 12, 'unit' => 'bouteille'],
